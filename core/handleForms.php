...
if (isset($_POST['insertUserBtn'])) {
	$insertUser = insertNewUsers($pdo,$_POST['Name'], $_POST['NursingHierarchy'], $_POST['Email'], $_POST['PhoneNumber'], $_POST['LicenseNumber']);
...
if (isset($_POST['editUserBtn'])) {
	$editUser = editUser($pdo,$_POST['Name'], $_POST['NursingHierarchy'], $_POST['Email'], $_POST['PhoneNumber'], $_POST['LicenseNumber'], $_GET['id']);
